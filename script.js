    ...
    if (heroCarouselElement) {
        ...
        const animateSlide = (slideElement) => {
            ...
            targets.forEach(target => {
                const delay = parseInt(target.getAttribute('data-anim-delay') || '0', 10);
        ...
        const initialActiveSlide = heroCarouselElement.querySelector('.carousel-item.active');
        ...
        heroCarouselElement.addEventListener('slide.bs.carousel', function (event) {
            ...
            // event.relatedTarget is the incoming slide element
             ...
             const carouselItems = heroCarouselElement.querySelectorAll('.carousel-item');
...
if (typeof observer !== 'undefined') {
    ...
    console.error("Intersection Observer not defined. Make sure the observer code is included before this part.");
}
...
// --- End Adding New Elements ---
$(document).ready(function(){ // Or use the vanilla JS DOMContentLoaded wrapper
    ...
    if ($bestSellerCarousel.length > 0) {
        $bestSellerCarousel.owlCarousel({
            ...
            responsive:{
                0:{ // breakpoint: 0px and up
                    items: 1 // Show 1 item
                },
                576:{ // breakpoint: 576px and up (sm)
                    items: 2 // Show 2 items
                },
                768:{ // breakpoint: 768px and up (md)
                    items: 3 // Show 3 items
                },
                992:{ // breakpoint: 992px and up (lg)
